        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <FormControlLabel
                  control={<Checkbox checked={eventData.registrationClosed} onChange={handleCheckboxChange} />}
              ...
              <Grid item xs={6}>
                <FormControlLabel
                  control={<Checkbox checked={eventData.isActive} onChange={handleCheckboxChange} />}
                  label="Active"
                  name="isActive"
                />
              </Grid>
              <Grid item xs={12}>
                <FormControlLabel
                  control={<Checkbox checked={eventData.isPaid} onChange={handleCheckboxChange} />}
                  label="Paid"
                  name="isPaid"
                />
              </Grid>
